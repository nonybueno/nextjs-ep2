    ...
    <header className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-[300px] flex justify-center items-center'>
        <div className='text-center'>
            ...
            <form onSubmit={handleForm} className='flex mt-2'>
                <input type="text" className='w-full rounded-md border border-gray-300 py-2 px-3 text-gray-700 shadow-md' 
                        placeholder='Pokemon Name...'
                        onChange={handleInput}/>
                <button className='inline-flex itmes-center mx-2 px-4 py-2 rounded-md bg-green-500 text-white shadow-md' type='submit'>Search</button>
            </form>
        </div>
    </header>
  )
